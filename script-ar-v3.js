...
function checkProximity() {
    ...
    panelPositions.forEach(p => {
        ...
        // 2. TRIGGER UPDATE: Increased to 1.0m
        // This ensures audio starts playing much sooner as you approach.
        // The "closestDist" logic ensures we don't play two at once.
        if (dist < 1.0) {
            if (dist < closestDist) {
                closestDist = dist;
                closestPanel = p.id;
